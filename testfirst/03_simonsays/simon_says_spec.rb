...
describe "Simon says" do
  ...
  describe "repeat" do
    ...
    it "should repeat sentences" do
      repeat("Pikachu is awesome", 2).should == "Pikachu is awesome Pikachu is awesome"
    end
  end

  describe "start_of word" do
  ...
  describe "titleize" do
    ...
    it "does capitalize 'little words' in a title" do
